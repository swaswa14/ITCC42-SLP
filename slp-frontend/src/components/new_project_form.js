      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={6}>
          <TextField
            ...
            value={formState.schoolYearStart}
            onChange={(e) => {
              handleChange(e);
            }}
            fullWidth
        ...
        <Grid item xs={6}>
          <TextField
            ...
            value={parseInt(formState.schoolYearStart, 10) + 1}
            onChange={handleChange}
            fullWidth
            type={"number"}
            disabled
        ...
        <Grid item xs={6}>
          <TextField
            name="startDateRemarks"
            label="Start Date Remarks"
            value={formState.startDateRemarks}
            onChange={handleChange}
            fullWidth
          />
        </Grid>
        ...
        <Grid item xs={6}>
          <TextField
            name="endDateRemarks"
            label="End Date Remarks"
            value={formState.endDateRemarks}
            onChange={handleChange}
            fullWidth
          />
        </Grid>
        <Grid item xs={6}>
          <MultipleStringInput
            strings={partnerOrFunders}
            setStrings={setPartnerOrFunders}
            label={"Partner/Funder"}
            placeHolder={"add a Partner/Funder"}
            name={"partnersOrFunders"}
            formState={formState}
        ...
        <Grid item xs={6}>
          <div>
            <MultipleStringInput
              strings={principalProponents}
              setStrings={setPrincipalProponents}
              label={"Principal Proponents"}
              placeHolder={"add Principal Proponents"}
              name={"principalProponent"}
              formState={formState}
              setFormState={setFormState}
            />
          </div>
        ...
        <Grid item xs={6}>
          <div>
            <MultipleStringInput
              strings={amountRemarks}
              setStrings={setAmountRemarks}
        ...
        <Grid item xs={6}>
          <MultipleStringInput
            strings={projectRemarks}
            setStrings={setProjectRemarks}
